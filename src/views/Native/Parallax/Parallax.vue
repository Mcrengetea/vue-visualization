    ...
    <div class="box" id="pageX">
        <div class="cards">
            ...
            <div class="card princess-mononoke">
                ...
                <img class="card__img" src="@/assets/image/3dr_mono.png" />
            ...
            <div class="card spirited-away">
                <div class="card__bg"></div>
                <img class="card__img" src="@/assets/image/3dr_chihiro.png" />
                <div class="card__text">
            ...
            <div class="card howl-s-moving-castle">
                <div class="card__bg"></div>
                <img class="card__img" src="@/assets/image/3dr_howlcastle.png" />
                <div class="card__text">
...
let images: any = null
// 所有背景
let backgrounds: any = null

// 旋转角度系数
let range = 40

// 旋转公式（返回-20 ~ 20，保留1为小数）
let calcValue = (a: any, b: any) => (a / b * range - range / 2).toFixed(1)
...
.princess-mononoke .card__bg {
    background: url("@/assets/image/3dr_monobg.jpg") center/cover no-repeat;
}
...
.spirited-away .card__bg {
    background: url("@/assets/image/3dr_spirited.jpg") center/cover no-repeat;
}
...
.howl-s-moving-castle .card__bg {
    background: url("@/assets/image/3dr_howlbg.jpg") center/cover no-repeat;
}
